...
//  HomeModel is for the NewBookViewController
...
class HomeModel: NSObject, URLSessionDataDelegate {
    ...
    var data = Data()
    let urlPath: String = "http://34.239.175.64/service.php" //this will be changed to the path where service.php lives
    func downloadItems() {
    ...
    func parseJSON(_ data:Data) {
        ...
        DispatchQueue.main.async(execute: { () -> Void in self.delegate.itemsDownloaded(items: books)})
        }
}
